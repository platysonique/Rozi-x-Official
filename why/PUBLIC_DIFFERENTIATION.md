...
1. Integrated organism, not a bolt-on verifier.
2. Pressure-tested under real financial stakes on the trading body — not only benchmarks; long-run money-path acceptance gates still open.
3. Multi-domain continuous operator surface under one authority membrane — **Operator** at the desk, **Rozi** herself, **External** as the remote door (people resolved after who is speaking, not split into twin Operator hubs).
4. Safety and capability designed together — verification is native law, not a tax bolted on later.

This page does **not** include grant strategy, Phase I proposal coaching, or private operator runbooks. The Architecture Voyage shows the Operator / Rozi / External picture in motion.
