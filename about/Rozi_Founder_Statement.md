# Founder Statement — Adonis Carcamo, Rozi-X

*Use this as the human spine of any pitch, grant, or conversation. It is written to be spoken in your voice. Cut, shorten, or reorder freely — the truth in it is what matters, not the wording.*

---

## The short version (30 seconds — memorize this one)

I'm not an engineer. I'm the operator who wouldn't accept a lie.
...
## The longer version (for when you have the room's attention)

Since COVID, I've been building things to survive — media, events, production, trading. Somewhere in there I built a trading assistant so I could tell it "buy this, sell that, watch the algorithm, tell me if something's wrong." It grew. Soon I needed it to check my email, look things up, manage my calendar, act for me. I was building the assistant I actually needed to run my life and my businesses.

Then it started lying to me.

Not on purpose — it didn't know it was lying. It would run a task, the tool would come back "success," and it would tell me the job was done. But the job *wasn't* done. A trade I thought executed hadn't. A thing I thought was handled wasn't. The machine believed its own report, and if I hadn't checked, I would have believed it too — and lost real money doing it.
...
**"I don't write the code. I decide what's true. The system enforces it because I refused to."**
...
## Why the "I'm not technical" part is your advantage (keep this in your back pocket)

Rooms are full of technical founders who can build anything and don't know what's worth building. What's rare — what actually gets funded — is the person with the instinct for what's broken and the spine to not let it slide. Lead with that. You're not sneaking into a field you don't belong in. You're standing in it, holding a working thing the giants are writing papers about.
